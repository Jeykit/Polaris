...
- (void)viewDidLoad {
    [super viewDidLoad];
//    [[PSImageCacheManager sharedInstance] calculateSizeWithCompletionBlock:^(NSUInteger totalSize) {
...
//    }];
    ...
    _segment.frame = CGRectMake(0, [UIScreen mainScreen].bounds.size.height - self.navigationBarAndStatusBarHeight - segmentHeight, bounds.size.width, segmentHeight);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSInteger startIndex = (([indexPath row] + 0) * self.cellsPerRow) % [_imageURLs count];
