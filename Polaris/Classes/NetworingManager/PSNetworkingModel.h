...
#define PSNetworkingModelInitialization(modelName ,parameterModel)\
...
@interface PSNetworkingModel : NSObject<YYModel>
 ...
 */
+ (void)POST:(NSString *)URLString parameters:(void(^)(PSParameterModel * parameter))parameters progress:(void (^)(NSProgress *progress))progress success:(void (^)(PSNetworkingModel *model ,NSArray<PSNetworkingModel *> *modelArray ,id responseObject))success failure:(void (^)(NSURLSessionDataTask *task, NSError *error, NSString *errorMsg))failure;
...
/**
 ...
 当响应数据成功返回时，success block会根据你之前的设置通过YYModel将响应数据转换为响应的模型(默认)，模型数组、原始数据。
 */
+ (void)POST:(NSString *)URLString parameters:(void(^)(PSParameterModel * parameter))parameters success:(void (^)(PSNetworkingModel *model ,NSArray<PSNetworkingModel *> *modelArray ,id responseObject))success failure:(void (^)(NSURLSessionDataTask *task, NSError *error, NSString *errorMsg))failure;
...
/**
 ...
 当响应数据成功返回时，success block会根据你之前的设置通过YYModel将响应数据转换为响应的模型(默认)，模型数组、原始数据。
 */
+ (void)GET:(NSString *)URLString parameters:(void(^)(PSParameterModel * parameter))parameters progress:(void (^)(NSProgress *progress))progress success:(void (^)(PSNetworkingModel *model ,NSArray<PSNetworkingModel *> *modelArray ,id responseObject))success failure:(void (^)(NSURLSessionDataTask *task, NSError *error, NSString *errorMsg))failure;
...
/**
 ...
 当响应数据成功返回时，success block会根据你之前的设置通过YYModel将响应数据转换为响应的模型(默认)，模型数组、原始数据。
 */
+ (void)GET:(NSString *)URLString parameters:(void(^)(PSParameterModel * parameter))parameters success:(void (^)(PSNetworkingModel *model ,NSArray<PSNetworkingModel *> *modelArray ,id responseObject))success failure:(void (^)(NSURLSessionDataTask *task, NSError *error, NSString *errorMsg))failure;
 ...
 */
+ (void)POST:(NSString *)URLString parameters:(void(^)(PSParameterModel * parameter))parameters images:(NSMutableArray *)images formData:(void (^)(id<AFMultipartFormData> formData))block progress:(void (^)(NSProgress *progress))progress success:(void (^)(PSNetworkingModel *model ,NSArray<PSNetworkingModel *> *modelArray ,id responseObject))success failure:(void (^)(NSURLSessionDataTask *task, NSError *error, NSString *errorMsg))failure;
...
/**
 ...
 当你需要上传大量图片时，直接把UIImage放在images数组里直接请求，然后等待请求结果
 */
+ (void)POST:(NSString *)URLString parameters:(void(^)(PSParameterModel * parameter))parameters images:(NSMutableArray *)images formData:(void (^)(id<AFMultipartFormData> formData))block success:(void (^)(PSNetworkingModel *model ,NSArray<PSNetworkingModel *> *modelArray ,id responseObject))success failure:(void (^)(NSURLSessionDataTask *task, NSError *error, NSString *errorMsg))failure;
...
/**
 ...
 当你需要上传大量图片时，直接把UIImage放在images数组里直接请求，然后等待请求结果
 */
+ (void)POST:(NSString *)URLString parameters:(void(^)(PSParameterModel * parameter))parameters images:(NSMutableArray *)images success:(void (^)(PSNetworkingModel *model ,NSArray<PSNetworkingModel *> *modelArray ,id responseObject))success failure:(void (^)(NSURLSessionDataTask *task, NSError *error, NSString *errorMsg))failure;
...
/**
 @param name PSNetworkingModel subclass name PSNetworkingModel的子类名称。这个类作为全局模型，请求回来数据会装换为当前类的模型
