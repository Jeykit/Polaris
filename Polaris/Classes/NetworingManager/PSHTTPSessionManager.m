...
@interface PSHTTPSessionManager()
@property(nonatomic, strong)AFHTTPSessionManager *sessionManager;
@end

@implementation PSHTTPSessionManager

#pragma mark - init
+(instancetype)sharedInstance{
    static __weak PSHTTPSessionManager * instance;
    PSHTTPSessionManager * strongInstance = instance;
    @synchronized (self) {
...
#pragma mark -images
-(void)POST:(NSString *)URLString parameters:(void (^)(PSParameterModel *))parameters images:(NSMutableArray *)images formData:(void (^)(id<AFMultipartFormData>))block progress:(void (^)(NSProgress *))progress success:(void (^)(PSNetworkingModel *model ,NSArray<NSObject *> *modelArray ,id responseObject))success failure:(void (^)(NSURLSessionDataTask *, NSError *, NSString *))failure{
...
-(void)POST:(NSString *)URLString parameters:(void (^)(PSParameterModel *))parameters images:(NSMutableArray *)images formData:(void (^)(id<AFMultipartFormData>))block success:(void (^)(PSNetworkingModel *, NSArray<NSObject *> *, id))success failure:(void (^)(NSURLSessionDataTask *, NSError *, NSString *))failure{
    
    [self POST:URLString parameters:parameters images:images formData:block progress:nil success:success failure:failure];
}

#pragma mark -GET
-(void)GET:(NSString *)URLString parameters:(void (^)(PSParameterModel *))parameters progress:(void (^)(NSProgress *))progress success:(void (^)(PSNetworkingModel *, NSArray<NSObject *> *, id))success failure:(void (^)(NSURLSessionDataTask *, NSError *, NSString *))failure{
    if (!URLString) {
        return;
    }
    NSString *requestURL = [NSString stringWithFormat:@"%@%@",domainMU?:@"",URLString];
...
-(void)GET:(NSString *)URLString parameters:(void (^)(PSParameterModel *))parameters success:(void (^)(PSNetworkingModel *, NSArray<NSObject *> *, id))success failure:(void (^)(NSURLSessionDataTask *, NSError *, NSString *))failure{
    [self GET:URLString parameters:parameters progress:nil success:success failure:failure];
}
#pragma mark-POST
-(void)POST:(NSString *)URLString parameters:(void (^)(PSParameterModel *))parameters progress:(void (^)(NSProgress *))progress success:(void (^)(PSNetworkingModel *, NSArray<NSObject *> *, id))success failure:(void (^)(NSURLSessionDataTask *, NSError *, NSString *))failure{
...
-(void)POST:(NSString *)URLString parameters:(void (^)(PSParameterModel *))parameters success:(void (^)(PSNetworkingModel *, NSArray<NSObject *> *, id))success failure:(void (^)(NSURLSessionDataTask *, NSError *, NSString *))failure{
    [self POST:URLString parameters:parameters progress:nil success:success failure:failure];
}

#pragma -mark 初始化
-(NSMutableDictionary *)dictionaryWithModle:(void (^)(PSParameterModel *))parameters{
    NSMutableDictionary *mDict = [NSMutableDictionary dictionary];
    if (parametersMU) {
        [mDict addEntriesFromDictionary:parametersMU];
    }
    //外部参数
    PSParameterModel *parameter = [NSClassFromString(paramterNameMU) new];
    if (parameters) {
...
-(void)modelWithDictionary:(id )responseObject requestURL:(NSString *)urlString success:(void (^)(PSNetworkingModel *model ,NSArray<NSObject *> *modelArray ,id responseObjects))success failure:(void (^)(NSURLSessionDataTask *, NSError *, NSString *))failure{
