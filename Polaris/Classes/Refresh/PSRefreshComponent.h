...
typedef NS_ENUM(NSUInteger ,PSRefreshingState){
    PSRefreshStateNone            = 1,
    PSRefreshStateScrolling,
    PSRefreshStateReady,
    PSRefreshStateRefreshing,
    PSRefreshStateWillEndRefresh
};

@interface PSRefreshComponent : UIView
 ...
 */
@property (copy, nonatomic) void (^refreshHandler)(PSRefreshComponent * component);

/**
 The threshold for trigger refresh default 1.0 PSst be set to not less than 1.0,
 ...
 */
@property (nonatomic) PSRefreshingState refreshState;
