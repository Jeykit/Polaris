...
- (UIImage *)navigationBarBackgroundImageM{
    self.navigationM.navigationBarBackgroundImageM =  self.navigationM.navigationBarBackgroundImageM?:self.navigationController.navigationM.navigationBarBackgroundImageM;
    return self.navigationM.navigationBarBackgroundImageM;
}
//阴影线
...
-(void)now_updateNaviagationBarInfo{
    ...
    if (!self.navigationM.fakeNavigationBar) {
        if (self.navigationBarBackgroundImageM) {
