...
@property(nonatomic, strong)PhotoPreviewView *carouselView;
...
@property (nonatomic,strong) PSCaptionView *captionView;
@end
...
-(PSCaptionView *)captionView{
    if (!_captionView) {
        _captionView = [[PSCaptionView alloc]init];
        [self.carouselView addSubview:_captionView];
    }
    return _captionView;
}
-(PhotoPreviewView *)carouselView{
    if (!_carouselView) {
        _carouselView = [[PhotoPreviewView alloc]initWithFrame:self.view.bounds];
...
- (CGRect)frameForCaptionView:(PSCaptionView *)captionView caption:(NSString *)caption{
...
- (void)setControlsHidden:(BOOL)hidden animated:(BOOL)animated permanent:(BOOL)permanent {
    ...
    __weak typeof(self)weakSelf = self;
    PSCaptionView *caption = _captionView;
