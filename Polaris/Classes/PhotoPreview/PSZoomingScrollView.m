...
#import "PSZoomingScrollView.h"
#import <objc/runtime.h>

@interface PSPhotoPlayVideoView : UIView

@end


@implementation PSPhotoPlayVideoView
...
@end
@interface PSZoomingScrollView()
@property(nonatomic, strong)PSTapDetectingView *tapView;
@property(nonatomic, strong)PSTapDetectingImageView *photoImageView;
@property (nonatomic,strong)PSPhotoPlayVideoView  *videoIndicatorView;
@end

@implementation PSZoomingScrollView

-(instancetype)init{
    if (self = [super init]) {
        // Tap view for background
        _tapView = [[PSTapDetectingView alloc] initWithFrame:self.bounds];
        ...
        // Image view
        _photoImageView = [[PSTapDetectingImageView alloc] initWithFrame:CGRectZero];
        ...
        _videoIndicatorView =  [[PSPhotoPlayVideoView alloc]initWithFrame:CGRectMake(0,0, 60., 60.)];
