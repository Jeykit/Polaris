...
@end
@interface PSAssetsViewController ()<PHPhotoLibraryChangeObserver ,UICollectionViewDelegateFlowLayout>
...
@implementation PSAssetsViewController
...
-(void)loadView{
    ...
    [collectionVoew registerClass:[PSAssetCell class] forCellWithReuseIdentifier:reuseIdentifier];
    [collectionVoew registerClass:[PSAssetsFooterView class] forSupplementaryViewOfKind:UICollectionElementKindSectionFooter withReuseIdentifier:reuseFooterIdentifier];
}
- (UILabel *)titleLabel{
    if (!_titleLabel) {
...
//    __block NSMutableArray *imagesArray = [NSMutableArray array];//PHImageManagerMaximumSize
    if (self.imagePickerController.selectedAssets.count >0) {
        if (self.imagePickerController.mediaType == PSImagePickerMediaTypeImage) {
            __block NSMutableArray *imagesArray = [NSMutableArray array];//PHImageManagerMaximumSize
        ...
        }else if (self.imagePickerController.mediaType == PSImagePickerMediaTypeVideo){
            __block NSMutableArray *imagesArray = [NSMutableArray array];//PHImageManagerMaximumSize
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    PSAssetCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:reuseIdentifier forIndexPath:indexPath];
...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath
{
    if (kind == UICollectionElementKindSectionFooter) {
        PSAssetsFooterView *footerView = [collectionView dequeueReusableSupplementaryViewOfKind:UICollectionElementKindSectionFooter
        ...
        switch (self.imagePickerController.mediaType) {
            case PSImagePickerMediaTypeAny:
            {
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!self.isEditing) {
        PhotoPreviewController *controller = [PhotoPreviewController new];
    ...
    PSAssetCell *cell = (PSAssetCell *)[collectionView cellForItemAtIndexPath:indexPath];
    PSImagePickerManager *imagePickerController = self.imagePickerController;
    NSMutableOrderedSet *selectedAssets = imagePickerController.selectedAssets;
    PHAsset *asset = self.fetchResult[indexPath.item];
    if (!imagePickerController.allowsMultipleSelection) {//sigle selected
        if (_lastSelectedItemIndexPath) {
            PSAssetCell *preCell = (PSAssetCell *)[collectionView cellForItemAtIndexPath:_lastSelectedItemIndexPath];
