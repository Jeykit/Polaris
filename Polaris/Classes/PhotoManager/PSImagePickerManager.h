...
typedef NS_ENUM(NSUInteger, PSImagePickerMediaType) {
    PSImagePickerMediaTypeAny = 0,
    PSImagePickerMediaTypeImage,
    PSImagePickerMediaTypeVideo
};
@interface PSImagePickerManager : NSObject
...
//资源类型
@property (nonatomic, assign) PSImagePickerMediaType mediaType;
