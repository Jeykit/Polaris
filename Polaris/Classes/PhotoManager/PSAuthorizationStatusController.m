...
@interface PSAuthorizationStatusController ()
@property(nonatomic, strong)UILabel *textLabel;
@property (nonatomic,weak) PSAssetsViewController *assetViewController;
@property (nonatomic, copy) NSArray *assetCollections;//资源集合
@end

@implementation PSAuthorizationStatusController
...
- (void)viewDidLoad {
    ...
    if (!count&&self.imagePickerController.mediaType == PSImagePickerMediaTypeImage) {
