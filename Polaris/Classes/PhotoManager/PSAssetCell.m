...
-(instancetype)initWithFrame:(CGRect)frame{
    if (self = [super initWithFrame:frame]) {
        ...
        _videoIndicatorView =  [[PSVideoIndicatorView alloc]initWithFrame:CGRectMake(0, height - 24., width, 24.)];
        ...
        _overlayView = [[PSOverlayView alloc]initWithFrame:CGRectMake(0, 0, width, width)];
