...
@implementation PSVideoIndicatorView
...
-(instancetype)initWithFrame:(CGRect)frame{
    if (self = [super initWithFrame:frame]) {
        ...
        _slomoIcon = [[PSSlomoIconView alloc]initWithFrame:CGRectMake(5., (CGRectGetHeight(frame) - 8.)/2.- 3, 12., 12.)];
        [self addSubview:_slomoIcon];
        
        _videoIcon = [[PSVideoIconView alloc]initWithFrame:CGRectMake(5., (CGRectGetHeight(frame) - 8.)/2., 14., 8.)];
